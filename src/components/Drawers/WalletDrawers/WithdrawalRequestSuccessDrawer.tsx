...
const WithdrawalRequestSuccessDrawer = () => {
  return (
    ...
    <View className='items-center justify-center'>
      ...
      <Txt fontSize={'lg'} fontWeight={700} className='mt-[14px]' fontColor={'textDefault'}>Request successful</Txt>
      <Txt fontColor={'neutral400'} textAlign={'center'} className='max-w-[275px] tracking-tight mt-2'>Withdrawal request has been placed, you will recieve the amount in your account once processed</Txt>
